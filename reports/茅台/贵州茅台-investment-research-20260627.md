...
> 本表只把第七、八步已给出的价格判断和对象化操作建议拆分为看板可读取字段；不改变报告的基本面结论，也不新增估值假设。

| 价格区间 | 空仓者动作 | 已持仓者动作 | 原文依据 |
|---|---|---|---|
| 900 元以下 | 分批建仓 | 可加仓，仍需确认基本面未恶化 | 明显低估，除非基本面恶化 |
| 900-1100 元 | 分批建仓 | 条件加仓：2026Q2/Q3 利润恢复至 +5% 以上 | 有吸引力；报告将 1000-1100 元列为舒服的加仓区间 |
| 1100-1300 元 | 分批建仓 | 持有，不追高加仓 | 合理偏低，可分批 |
| 1300-1500 元 | 观察，不追价 | 持有，不加仓 | 合理，安全边际一般；重仓者不必因为“便宜”继续加满 |
| 1500 元以上 | 观察，等待利润重新加速 | 持有，等待利润重新加速确认 | 需要利润重新加速支撑 |
