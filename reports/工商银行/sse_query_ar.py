...
for code in codes:
    params={
    'isPagination':'true','productId':code,'keyWord':kw,'securityType':'0101,120100,020100,020200,120200','reportType':'ALL','beginDate':'2026-01-01','endDate':'2026-05-10','pageHelp.pageSize':'20','pageHelp.pageNo':'1','pageHelp.beginPage':'1','pageHelp.cacheSize':'1','pageHelp.endPage':'1'}
